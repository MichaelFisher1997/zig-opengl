...
pub const WorldScreen = struct {
    ...
    pub fn draw(ptr: *anyopaque, ui: *UISystem) !void {
        ...
        const cloud_params: rhi_pkg.CloudParams = blk: {
            ...
            break :blk .{
                ...
                .shadow_samples = ctx.settings.shadow_pcf_samples,
                .shadow_blend = ctx.settings.shadow_cascade_blend,
        ...
        const render_ctx = render_graph_pkg.SceneContext{
            ...
            .env_map_handle = if (ctx.env_map.*) |t| t.handle else 0,
    ...
    pub fn screen(self: *WorldScreen) IScreen {
        return .{
            .ptr = self,
            .vtable = &.{
                .deinit = deinit,
